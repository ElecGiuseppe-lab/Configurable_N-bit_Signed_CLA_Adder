...
* **2's Complement Sign Representation:** Sign extension has been implemented to ensure the correct representation of negative values. For positive operands, an adequate word length must be used to prevent overflow (e.g. 255 -> 8-bit to extend 9-bit).
